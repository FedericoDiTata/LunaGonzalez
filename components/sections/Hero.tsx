...
/** Headline provisional (copy definitivo en entrega 2). */
const HEADLINE = "Coaching para personas y equipos que trabajan mejor";
...
export default function Hero() {
  return (
    <section
      id="inicio"
      className="relative bg-paper [--edge-w:40vw] lg:flex lg:min-h-[92vh] lg:flex-col"
    >
      {/* Contenido — z-10 sobre la foto. El headline se topea con cross-right:
          su borde derecho cruza la foto a lo sumo --edge-cap, a todos los anchos. */}
      <motion.div
      ...
      >
        <div className="mx-auto w-full max-w-6xl px-6">
          <div className="flex flex-col gap-2 py-5 sm:flex-row sm:items-center sm:justify-between lg:max-w-[58%]">
            {META.map((m) =>
              m.href ? (
                <a
                  key={m.label}
